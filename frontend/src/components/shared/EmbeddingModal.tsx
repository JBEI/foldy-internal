...
export const EmbeddingModal: React.FC<EmbeddingModalProps> = ({
    ...
    const [dmsStartingSeqIds, setDmsStartingSeqIds] = useState<string>(templateEmbedding?.dms_starting_seq_ids || 'WT');
    const [extraSequenceIDs, setExtraSequenceIDs] = useState<string>(templateEmbedding?.extra_seq_ids || '');
