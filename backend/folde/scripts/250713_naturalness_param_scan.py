...
NAME = "250713-naturalness-param-scan"
...
config_list = apply_diff_list_to_config(
    base_config,
    [
        ModelDiff(name="300m", diffs={"naturalness_model_id": "300m"}),
        ModelDiff(name="600m", diffs={"naturalness_model_id": "600m"}),
        ModelDiff(name="8m", diffs={"naturalness_model_id": "8m"}),
        ModelDiff(name="35m", diffs={"naturalness_model_id": "35m"}),
        ModelDiff(name="150m", diffs={"naturalness_model_id": "150m"}),
