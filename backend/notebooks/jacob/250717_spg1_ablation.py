...
NAME = "250819-spg1-ablation-REDO"
...
mlp_config_list = apply_diff_list_to_config(
    ...
    [
        ...
        ModelDiff(
            name="no-constantliar-with-ucb", diffs={"few_shot_model_params.decision_mode": "ucb"}
        ),
        ModelDiff(name="clS1", diffs={"few_shot_model_params.lie_noise_stddev_multiplier": 1.0}),
