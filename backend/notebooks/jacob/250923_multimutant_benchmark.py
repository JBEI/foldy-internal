...
NAME = "250923-multimutant-benchmark"
...
config_list = (
    ...
    + apply_diff_list_to_config(
        ...
        [
            ...
            ModelDiff(
                name="no-clS3", diffs={"few_shot_model_params.lie_noise_stddev_multiplier": 3.0}
            ),
            ModelDiff(
                name="no-clS1", diffs={"few_shot_model_params.lie_noise_stddev_multiplier": 1.0}
            ),
            ModelDiff(
                name="clS6-schedule",
                diffs={
