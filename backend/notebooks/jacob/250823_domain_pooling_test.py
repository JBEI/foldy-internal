...
NAME = "250823-domain-pooling-test"
...
mlp_config_list = apply_diff_list_to_config(
    folde_config,
    [
        ModelDiff(name="nowarmstart", diffs={"few_shot_model_params.pretrain": False}),
        ModelDiff(name="domainpooling", diffs={"embedding_model_id": "300m_domainpooling"}),
        ModelDiff(
            name="domainpooling-nowarmstart",
            diffs={
                "embedding_model_id": "300m_domainpooling",
