...
class TestCampaignWorldState:
    ...
    def test_get_unmeasured_variants(self):
        ...
        assert len(unmeasured_naturalness_df) == len(naturalness_df) - len(seq_ids_to_measure)
        assert len(unmeasured_embeddings_df) == len(embedding_df) - len(seq_ids_to_measure)
